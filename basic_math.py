...
revenue = int(input("What was your revenue this year?"))
...
print( "Company 1 recorded $", revenue, " in revenue this year, paid $ ", taxes_paid, " in taxes, recorded a profit of $", profit, "and paid $ ", profit / 5, "to their five shareholders evenly")
# TAKEAWAY:
# 1) Variables that have input functions stored in them will be of the string type. To use them in1
...
print("The minimum of num_list is ", min_num)
print("The maximum of num_list is ", max_num)
print("The sum of num_list is ", sum_list)
